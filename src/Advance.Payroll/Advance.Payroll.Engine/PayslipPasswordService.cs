...
public static class PayslipPasswordService
{
    ...
    // เดิม: Resolve(Hremployee employee, ...) — ตอนนี้รับ PayEmployeeSnapshot (IEmployeeSource) แทน
    public static PasswordResult Resolve(PayEmployeeSnapshot employee, string template)
    {
