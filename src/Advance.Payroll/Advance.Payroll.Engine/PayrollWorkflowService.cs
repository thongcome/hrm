...
public class PayrollWorkflowService
{
    ...
    public PayrollWorkflowService(IDbContextFactory<PayrollDbContext> dbFactory, PayrollCalculationService calculationService,
    ...
    private static async Task EnsureReadyForReviewAsync(PayrollDbContext context, Pay_PayrollRun run, CancellationToken ct)
    {
    ...
    private static async Task<Pay_PayrollRun> LoadRunOrThrowAsync(PayrollDbContext context, long runId, CancellationToken ct)
    ...
    private static void AddTransitionLog(PayrollDbContext context, long runId, PayrollRunStatus fromStatus, PayrollRunStatus toStatus, long actorUserId, string? comment = null)
    {
        context.Pay_PayrollAuditLogs.Add(new Pay_PayrollAuditLog
        {
            PayrollRunId = runId,
