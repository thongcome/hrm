...
// Ported verbatim from HRM Services/Pay/Calculators/SeveranceCalculator.cs. Not on the task's
// required Core list, but genuinely pure (no DB, no HRM types) so included for free.
