...
public partial class Hrucfsecurity
{
    ...
    [Column("SECURITY_MONEY", TypeName = "NUMBER(10,2)")]
    public decimal? SecurityMoney { get; set; }

    [Column("OVER_SECURITY_MONEY", TypeName = "NUMBER(10,2)")]
    ...
    //[Column("isFix", TypeName = "NUMBER(1)")]
    //public bool isFix { get; set; } = false;

    //[Column("FixAmount", TypeName = "NUMBER(15,2)")]
