...
**ฉบับ v1.0 · 26 ก.ย. 2569** · งานจาก CEO (เซสชัน ADP AI): "ใช้ของ ADP.AI เป็นตัวหลัก ส่งงานให้ HRM กับ Payroll"
...
| ขอบเขต | อ่านอย่างเดียวทั้งสองฝั่ง · **ไม่ได้แก้โค้ด** · ไม่ได้เปลี่ยน ProjectReference · ไม่ได้ลบสำเนาใด · บั๊ก 5 ข้อที่ HRM ยืนยันไว้แล้ว **ยังไม่แก้** (รอ CEO สั่ง) |
