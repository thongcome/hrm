...
namespace HRM.Migrations.ApplicationDb
{
    ...
    [Migration("20260729075927_AddApplicationUserIdentityFields")]
    partial class AddApplicationUserIdentityFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HRM.Model.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Model.GoalTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Model.ScUser", b =>
                {
                    b.Property<long>("Userid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HRM.Model.SubTask", b =>
                {
            ...
            modelBuilder.Entity("HRM.Model.TaskMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Model.TodoTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Model.WOL", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Model.Activity", b =>
                {
                    b.HasOne("HRM.Model.GoalTask", "GoalTask")
                        .WithMany("Activity")
            ...
            modelBuilder.Entity("HRM.Model.SubTask", b =>
                {
                    b.HasOne("HRM.Model.TodoTask", "TodoTask")
                        .WithMany("SubTasks")
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HRM.Data.ApplicationUser", null)
                        .WithMany()
